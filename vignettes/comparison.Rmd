...
|--------|---------|----------|
| Exact / pruned optimal partitioning | PELT, BinSeg, SegNeigh, AMOC, FPOP, gfpop | Dynamic programming with pruning [@killick2012pelt; @maidstone2017optimal; @hocking2020gfpop] |
...
- The R package references for the individual detection engines: **changepoint**
  ...
  **gfpop** [@hocking2020gfpop], **changepoint.np**
  [@haynes2017computationally], and **ecp** [@james2014ecp].
