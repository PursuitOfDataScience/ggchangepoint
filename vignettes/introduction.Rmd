...
changepoint at $\sigma = 1$ but returns 29 at $\sigma = 3$ and 138 at
$\sigma = 10$. Standardise the series, pass a penalty on the data's own
...
level as part of their procedure — SMUCE, the WBS family, CPOP, DeCAFS, and
...
- `data`: the analysed series as a tibble (`index`, `value`), plus a
  ...
  bcp, BEAST, DeCAFS, segmented, mcp, bfast --- the engines
