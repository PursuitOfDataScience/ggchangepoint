...
changepoint at $\sigma = 1$ but returns 27 at $\sigma = 3$ and 76 at
$\sigma = 10$ (means over 20 draws, since a single draw is not stable at
these settings), and warns that its cost assumes unit noise. Standardise the series, pass a penalty on the data's own
