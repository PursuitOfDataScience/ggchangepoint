...
Four companion vignettes go deeper: `vignette("introduction")` develops the
...
learned penalties, and `vignette("extending")` shows how to bring an
external detector into the same grammar.
...
exported surface, one example each; three companion vignettes develop these
properly.
