...
index, a label for the axis, and any seasonal frequency the input carried
(which is how `cpt_detect(monthly_ts, method = "bfast")` fits at the right
frequency instead of the wrapper's default):
