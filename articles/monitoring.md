...
null on iid noise they hold up. Measured on 2000-observation in-control
streams at the defaults, `cpm` raises about **3.7** false alarms against
the 4 that `arl0 = 500` implies by construction, and `edetector` about
**13**.
