...
**Author:** Youzhi Yu
**Status:** Release ledger for `ggchangepoint` 0.4.0 (Part I) and design roadmap
for 0.5.0 and beyond (Part II)
**Current release:** 0.3.0 on CRAN; **0.4.0 complete and ready to submit**
